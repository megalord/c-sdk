...
typedef struct _newrelic_transaction_tracer_config_t {
  ...
  /** If the SDK configuration threshold is set to
  ...
  /** Sets the threshold above which the New Relic SDK will record a
  ...
  /** The datastore_reporting field of newrelic_transaction_tracer_config_t
...
typedef struct _newrelic_process_config_t {
  /**
   *  Specify the communication mechanism by setting daemon_socket to a
   *  socket name.
   *
...
typedef struct _newrelic_app_config_t {
  ...
  /** Optional. Specifies the file to be used for C SDK logs.  If no filename
